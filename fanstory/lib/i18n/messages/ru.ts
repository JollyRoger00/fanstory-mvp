const ruMessages = {
  ...
  landing: {
    ...
    description:
      "Запускайте AI-историю, влияйте на каждую главу своими решениями и держите все сохранения в одном месте.",
    ...
    architectureCards: [
      ...
      },
      {
        title: "Гибкий доступ",
        description:
          "Используйте стартовые главы, пакеты, рекламу или подписку.",
      },
    ],
    pillars: [
      {
        title: "Ваша библиотека",
        description: "Все истории и сохранения привязаны к вашему аккаунту.",
      },
      {
        title: "Глава за главой",
        description:
          "Продолжайте историю, когда захотите, и перечитывайте бесплатно.",
      },
      {
        title: "Понятная монетизация",
        description:
          "Сначала тратятся стартовые главы, потом подписка, пакеты и только затем реклама.",
      },
    ],
  },
  signIn: {
